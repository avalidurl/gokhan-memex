...
(function () {
  ...
  var CSS = '.lp{position:absolute;z-index:9999;max-width:340px;width:max-content;border:2px solid var(--ink,#0a0a0a);background:var(--paper,#f4f4f2);color:var(--ink,#0a0a0a);padding:.7rem .85rem;font-family:"SF Mono","IBM Plex Mono","JetBrains Mono",ui-monospace,Menlo,monospace;opacity:0;transform:translateY(4px);transition:opacity .12s,transform .12s;pointer-events:none}.lp.show{opacity:1;transform:translateY(0);pointer-events:auto}.lp .lp-k{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:var(--dim,#5c5c5c)}.lp .lp-t{font-weight:700;font-size:14px;line-height:1.25;margin:.15rem 0 .3rem;color:var(--ink,#0a0a0a)}.lp .lp-d{font-size:12.5px;line-height:1.5;color:var(--dim,#5c5c5c)}.lp a.lp-o{display:inline-block;margin-top:.5rem;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:11px;letter-spacing:.04em;color:var(--ink,#0a0a0a);border:0;text-decoration:underline;text-underline-offset:2px}@media (prefers-reduced-motion:reduce){.lp{transition:none}}';
