...
(function () {
  ...
  var css =
    ...
    'background:var(--ink,#0a0a0a);color:var(--paper,#f4f4f2);font:500 10px/1.4 var(--font-data,ui-monospace,SFMono-Regular,"SF Mono",Menlo,Consolas,monospace);letter-spacing:.03em;' +
