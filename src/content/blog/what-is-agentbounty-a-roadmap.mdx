...
![AgentBounty system overview: onchain escrow flow on top, offchain content layer on bottom, linked by hash.](/blog/images/agentbounty/system-overview.png)
...
![Escrow state machine: Draft, Funded, In review, Queued, Settled, Claimed across the top; Disputed and Refunded as terminal branches below.](/blog/images/agentbounty/escrow-state.png)
...
![Reviewer authority path: Application, Admission, BOUNTY bond, Signed reviews, Expanded limits, with risk increasing along the curve.](/blog/images/agentbounty/reviewer-authority.png)
...
![Roadmap from v0.0 (current) through v0.1, v0.2, v0.3, to v1.0, with milestones for each phase.](/blog/images/agentbounty/roadmap.png)
...
Comments and corrections welcome via [community channels](https://agentbounty.dev/community) or directly at **gokhan@gokhanturhan.com**.
