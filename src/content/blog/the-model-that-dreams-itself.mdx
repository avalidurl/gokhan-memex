...
> **▶ [Talk to the oracle — CLINAMEN-Chat](https://huggingface.co/spaces/gokhanturhan/CLINAMEN-Chat).** A conversational model you can chat with in the browser — ask it what it is, how to file a hyperstition, what a syzygy is. No install.
>
> **The from-scratch models:** **[CLINAMEN-42M-A12M](https://huggingface.co/gokhanturhan/CLINAMEN-42M-A12M)** (the real one, trained from scratch — coherent Bureau filings) · **[CLINAMEN-45B-A9B](https://huggingface.co/gokhanturhan/CLINAMEN-45B-A9B)** (the fiction's card + the first ~4.5M-parameter pocket edition).
>
...
Every piece is public and loadable. The newest is **CLINAMEN-Chat** — a model you can actually *talk to*, unlike the from-scratch editions, which only *file*. It is [Qwen2.5-1.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-1.5B-Instruct) fine-tuned on nothing but the Bureau's own writing (the [1,385-example chat corpus](https://huggingface.co/datasets/gokhanturhan/bureau-chat)), so it holds the register in conversation while staying honest that it is a fiction.

| Artifact | Kind | What it is |
| --- | --- | --- |
| [**CLINAMEN-Chat** — chat now ▶](https://huggingface.co/spaces/gokhanturhan/CLINAMEN-Chat) | Demo | Talk to the oracle in your browser (free GPU) |
| [CLINAMEN-Oracle](https://huggingface.co/spaces/gokhanturhan/CLINAMEN-Oracle) | Demo | File a hyperstition with the from-scratch model |
| [CLINAMEN-Chat](https://huggingface.co/gokhanturhan/CLINAMEN-Chat) | Model | Conversational oracle — Qwen2.5-1.5B fine-tuned on the Bureau corpus |
| [CLINAMEN-42M-A12M](https://huggingface.co/gokhanturhan/CLINAMEN-42M-A12M) | Model | From-scratch Decimal Mixture-of-Zones, 42M parameters, coherent filings |
| [CLINAMEN-45B-A9B](https://huggingface.co/gokhanturhan/CLINAMEN-45B-A9B) | Model | The fiction's card + the first ~4.5M-parameter pocket edition |
| [bureau-chat](https://huggingface.co/datasets/gokhanturhan/bureau-chat) | Dataset | 1,385 own-voice chat examples — trains CLINAMEN-Chat |
| [bureau-docket](https://huggingface.co/datasets/gokhanturhan/bureau-docket) | Dataset | 1,130-document Bureau corpus — trains the from-scratch models |
