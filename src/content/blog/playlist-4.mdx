...
![Silencio by Eugen Gomringer (1954)](/images/silencio-eugen-gomringer-1954.gif)One needs to create spaces out of both sound and the unsound. The unsound is by no means silence. As above, not so much so below. It is rather sound that is not hospitable to conventions in contemporaneous understanding of sound-born arts which range from pop music to video-art that cannot be thought of without its underlying score.
