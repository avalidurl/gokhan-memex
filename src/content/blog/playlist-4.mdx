...
description: "Musicians and sound artists incorporating sound into their on-chain works, listening to the mempool at all times."
# heroImage: "/images/playlist-4-hero.png"
tags:
  - ai
  - art
  - conceptual poetry
  ...
  - web3
category: "Music"
# socialImage: "/images/playlist-4-hero.png"
draft: false
source: paragraph
...
import AlertDescription from '../../components/ui/AlertDescription.astro';
import { TriangleAlert } from 'lucide-astro';

<Alert variant="destructive">
  <TriangleAlert size={16} />
  <AlertDescription>
    There were 4 Zora origin NFTs here but since they nuked all of the frontends prior to their mobile app, it's now a pain in the ass to fetch those properly. Sorry for the inconvenience.
  </AlertDescription>
</Alert>

## For those Who Sit in a Smart Contract
...
Yes, I am a fan of Alvin Lucier but I do not know how to recycle sound within, and through, a smart contract across EVM—yet.
...
I am one of those sinners who happen stash their hand-tagged digital music files in a sinful manner where Mariah meets Molton meets John Cage—those [Kenneth Goldsmith](https://bombmagazine.org/articles/unedited-transcript-kenneth-goldsmith/) spake of for countless times in myriad interviews as much as I recall.
...
![Silencio by Eugen Gomringer (1954)](/images/silencio-eugen-gomringer-1954.gif)
...
[Iannis Xenakis](https://jrp-editions.com/art/books/art-theory/documents-series/a-brief-history-of-new-music/) tells HUO in one of their interviews that “[he himself and Le Corbusier] decided to work together on [that] idea that constructions of space [[sic]] are similar to those of sound.”
